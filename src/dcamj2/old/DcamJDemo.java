...
import dcamj2.old.DcamAcquisitionListener;
...
public class DcamJDemo
{
                                            ...
                                            IOException
  {
    ...
    final DcamImageSequence[] lDcamFrameArray =
                                      new DcamImageSequence[lNumerOfDcamFrames];
    for (int i = 0; i < lNumerOfDcamFrames; i++)
      lDcamFrameArray[i] = new DcamImageSequence(2,
                                         lImageResolution,
                                         lImageResolution,
    ...
    for (int j = 0; j < lNumerOfDcamFrames; j++)
      for (int i = 0; i < lDcamFrameArray[j].getDepth(); i++)
      {
        final double average =
                             computeAverageInBuffer(lDcamFrameArray[j].getMemoryForPlane(i));
