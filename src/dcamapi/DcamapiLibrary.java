...
public class DcamapiLibrary {
	...
	public enum DCAMERR implements IntValuedEnum<DCAMERR > {
		...
		DCAMERR_NOCOMBINATION(-2147483128),
		DCAMERR_FAILOPEN(-2147479551),
		...
		/// 2.2:old API does not support the value because only new API supports the value
		...
		/// 2.2:the conbination of subarray values are invalid. e.g. DCAM_IDPROP_SUBARRAYHPOS + DCAM_IDPROP_SUBARRAYHSIZE is greater than the number of horizontal pixel of sensor.
		...
		/**
		 * DCAMERR_MISSINGRELATEDFILE	= 0x80000837,/*		File could be opened but necessary file is missing, e.g. DLL, file body, ... * /<br>
		...
		DCAMERR_UNLOADED(-2147479804),
		DCAMERR_THRUADAPTER(-2147479803),
		...
		public static IntValuedEnum<DCAMERR > fromValue(int value) {
	...
	public enum DCAM_USERDATAKIND implements IntValuedEnum<DCAM_USERDATAKIND > {
		...
		public static IntValuedEnum<DCAM_USERDATAKIND > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAM_PIXELTYPE implements IntValuedEnum<DCAM_PIXELTYPE > {
		...
		public static IntValuedEnum<DCAM_PIXELTYPE > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMBUF_ATTACHKIND implements IntValuedEnum<DCAMBUF_ATTACHKIND > {
		...
		public static IntValuedEnum<DCAMBUF_ATTACHKIND > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMCAP_STATUS implements IntValuedEnum<DCAMCAP_STATUS > {
		...
		end_of_dcamcap_status((int)DcamapiLibrary.DCAMCAP_STATUS.DCAMCAP_STATUS_UNSTABLE.value() + 1);
		DCAMCAP_STATUS(long value) {
			this.value = value;
		}
		public final long value;
		public long value() {
		...
		public static IntValuedEnum<DCAMCAP_STATUS > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMWAIT_EVENT implements IntValuedEnum<DCAMWAIT_EVENT > {
		...
		end_of_dcamwait_event((int)DcamapiLibrary.DCAMWAIT_EVENT.DCAMCAP_EVENT_STOPPED.value() + 1);
		DCAMWAIT_EVENT(long value) {
			this.value = value;
		}
		public final long value;
		public long value() {
		...
		public static IntValuedEnum<DCAMWAIT_EVENT > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMCAP_START implements IntValuedEnum<DCAMCAP_START > {
		...
		public static IntValuedEnum<DCAMCAP_START > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAM_IDSTR implements IntValuedEnum<DCAM_IDSTR > {
		...
		public static IntValuedEnum<DCAM_IDSTR > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMWAIT_TIMEOUT implements IntValuedEnum<DCAMWAIT_TIMEOUT > {
		...
		end_of_dcamwait_timeout((int)DcamapiLibrary.DCAMWAIT_TIMEOUT.DCAMWAIT_TIMEOUT_INFINITE.value() + 1);
		DCAMWAIT_TIMEOUT(long value) {
			this.value = value;
		}
		public final long value;
		public long value() {
		...
		public static IntValuedEnum<DCAMWAIT_TIMEOUT > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAM_METADATAKIND implements IntValuedEnum<DCAM_METADATAKIND > {
		...
		public static IntValuedEnum<DCAM_METADATAKIND > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMREC_STATUSFLAG implements IntValuedEnum<DCAMREC_STATUSFLAG > {
		...
		DCAMREC_STATUSFLAG_RECORDING(1);
		DCAMREC_STATUSFLAG(long value) {
			this.value = value;
		}
		public final long value;
		public long value() {
		...
		public static IntValuedEnum<DCAMREC_STATUSFLAG > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMPROPOPTION implements IntValuedEnum<DCAMPROPOPTION > {
		/**
		 * direction flag for dcam_getnextpropertyid(), dcam_querypropertyvalue() **<br>
		 * prior value
		 */
		...
		public static IntValuedEnum<DCAMPROPOPTION > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMPROPATTRIBUTE implements IntValuedEnum<DCAMPROPATTRIBUTE > {
		...
		public static IntValuedEnum<DCAMPROPATTRIBUTE > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMPROPATTRIBUTE2 implements IntValuedEnum<DCAMPROPATTRIBUTE2 > {
		...
		public static IntValuedEnum<DCAMPROPATTRIBUTE2 > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMPROPUNIT implements IntValuedEnum<DCAMPROPUNIT > {
		...
		public static IntValuedEnum<DCAMPROPUNIT > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMPROPMODEVALUE implements IntValuedEnum<DCAMPROPMODEVALUE > {
		...
		public static IntValuedEnum<DCAMPROPMODEVALUE > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
	...
	public enum DCAMIDPROP implements IntValuedEnum<DCAMIDPROP > {
		 ...
		 * reserved
		 */
		DCAM_IDPROP_CONTRASTGAIN_RATIO((int)DcamapiLibrary.DCAMIDPROP.DCAM_IDPROP__RATIO.value() | (int)DcamapiLibrary.DCAMIDPROP.DCAM_IDPROP_CONTRASTGAIN.value()),
		DCAM_IDPROP__CHANNEL(1),
		DCAM_IDPROP__VIEW(16777216),
		DCAM_IDPROP__MASK_CHANNEL(15),
		DCAM_IDPROP__MASK_VIEW(251658240),
		DCAM_IDPROP__MASK_BODY(16777200),
		...
		public static IntValuedEnum<DCAMIDPROP > fromValue(int value) {
			return FlagSet.fromValue(value, values());
		}
	};
	/**
