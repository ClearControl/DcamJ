...
public class DCAMREC_OPENA extends StructObject
{
	...
	@CLong
	@Field(0)
	public DCAMREC_OPENA size(final long size)
	{
	...
	@CLong
	@Field(1)
	public DCAMREC_OPENA reserved(final long reserved)
	{
	 ...
	 */
	@Field(2)
	public DCAMREC_OPENA hrec(final Pointer<HDCAMREC_struct> hrec)
	{
	 ...
	 */
	@Field(3)
	public DCAMREC_OPENA path(final Pointer<Byte> path)
	{
	 ...
	 */
	@Field(4)
	public DCAMREC_OPENA ext(final Pointer<Byte> ext)
	{
	...
	@CLong
	@Field(5)
	public DCAMREC_OPENA maxframepersession(final long maxframepersession)
	{
	...
	@CLong
	@Field(6)
	public DCAMREC_OPENA userdatasize(final long userdatasize)
	{
	...
	@CLong
	@Field(7)
	public DCAMREC_OPENA userdatasizeSession(final long userdatasizeSession)
	{
	...
	@CLong
	@Field(8)
	public DCAMREC_OPENA userdatasizeFile(final long userdatasizeFile)
	{
	...
	@CLong
	@Field(9)
	public DCAMREC_OPENA usertextsize(final long usertextsize)
	{
	...
	@CLong
	@Field(10)
	public DCAMREC_OPENA usertextsizeSession(final long usertextsizeSession)
	{
	...
	@CLong
	@Field(11)
	public DCAMREC_OPENA usertextsizeFile(final long usertextsizeFile)
	{
		this.io.setCLongField(this, 11, usertextsizeFile);
		return this;
	}

	public DCAMREC_OPENA(final Pointer pointer)
	{
		super(pointer);
	}
}
