...
public class DCAMDEV_STRING extends StructObject {
	...
	@CLong 
	@Field(0) 
	public DCAMDEV_STRING size(long size) {
	...
	@CLong 
	@Field(1) 
	public DCAMDEV_STRING iString(long iString) {
	 ...
	 */
	@Field(2) 
	public DCAMDEV_STRING text(Pointer<Byte > text) {
	...
	@CLong 
	@Field(3) 
	public DCAMDEV_STRING textbytes(long textbytes) {
		this.io.setCLongField(this, 3, textbytes);
		return this;
	}
	public DCAMDEV_STRING(Pointer pointer) {
		super(pointer);
	}
}
