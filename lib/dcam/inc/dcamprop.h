...
typedef struct DCAM_PARAM_PROPERTYATTR
{
	...
	long	iProp;			/*	DCAMIDPROPERTY			*/
	long	option;			/*	DCAMPROPOPTION			*/
	...
	long	nMaxChannel;	/*	max channel if supports	*/
	long	iReserved3;		/*	reserved to 0			*/
	long	nMaxView;		/*	max view if supports	*/

	/* available from DCAM-API 3.03 */
	long	iProp_NumberOfElement;	/*	number of elements for array	*/
	long	iProp_ArrayBase;		/*	base id of array if element		*/
	long	iPropStep_Element;		/*	step for iProp to next element	*/
} DCAM_PROPERTYATTR;

typedef struct DCAM_PARAM_PROPERTYVALUETEXT
{
	long	cbSize;						// [in] of this structure
	long	iProp;						// [in] DCAMIDPROP
	double	value;						// [in] value of property
	char*	text;						// [in,obuf] text of the value
	long	textbytes;					// [in] text buf size
...
BOOL DCAMAPI dcam_getpropertyvalue	( HDCAM h, long iProp, double* pValue );
BOOL DCAMAPI dcam_setpropertyvalue	( HDCAM h, long iProp, double  fValue );

BOOL DCAMAPI dcam_setgetpropertyvalue(HDCAM h, long iProp, double* pValue, long option DCAM_DEFAULT_ARG );
BOOL DCAMAPI dcam_querypropertyvalue( HDCAM h, long iProp, double* pValue, long option DCAM_DEFAULT_ARG );

BOOL DCAMAPI dcam_getnextpropertyid	( HDCAM h, long* pProp, long option DCAM_DEFAULT_ARG );
BOOL DCAMAPI dcam_getpropertyname	( HDCAM h, long iProp, char* text, long textbytes );
...
typedef enum _DCAMPROPATTRIBUTE2
{
	...
	DCAMPROP_ATTR2__FUTUREUSE	= 0x002FFFFC
} DCAMPROPATTRIBUTE2;
...
//	DCAMPROP_OUTPUTTRIGGER_KIND__PROGRAMABLE1	= 31,			/*	"PROGRAMABLE 1"			*/
//	DCAMPROP_OUTPUTTRIGGER_KIND__PROGRAMABLE2	= 32,			/*	"PROGRAMABLE 2"			*/
//	DCAMPROP_OUTPUTTRIGGER_KIND__PROGRAMABLE3	= 33,			/*	"PROGRAMABLE 3"			*/
...
/*	DCAMPROP_CONTRAST_CONTROL__FRONTPANEL		= 3,	*/		/*	"FRONT PANEL"			*/	/* reserved */
	...
	/* DCAM_IDPROP_TIMING_TIMESTAMP */
	DCAMPROP_TIMING_TIMESTAMP__NONE					= 1,			/* "NONE"					*/
	DCAMPROP_TIMING_TIMESTAMP__ROLLINGEXPOSURE_START= 2,			/* "ROLING EXPOSURE START"	*/
	DCAMPROP_TIMING_TIMESTAMP__GLOBALEXPOSURE_START	= 3,			/* "GLOBAL EXPOSURE START"	*/
	DCAMPROP_TIMING_TIMESTAMP__GLOBALEXPOSURE_END	= 4,			/* "GLOBAL EXPOSURE END"			*/
	...
	DCAMPROP_TIMING_TIMESTAMP__DCAMFRAME_END		= 11,			/* "EXPOSURE_START"			*/
...
/*	DCAM_IDPROP_OUTPUTTRIGGER_SOURCE			= 0x001C0110,*/	/* R/W, mode,	"OUTPUT TRIGGER SOURCE"	*/	/* reserved */
	...
	DCAM_IDPROP_OUTPUTTRIGGER_KIND				= 0x001C0160,	/* R/W, sec,	"OUTPUT TRIGGER KIND"  */

	DCAM_IDPROP__OUTPUTTRIGGER					= 0x00000100,	/* the offset of ID for Nth OUTPUT TRIGGER parameter */
												//reserved until 0x001C1060. the reserved count is 16.
...
//	DCAM_IDPROP_INTERNAL_LINEINTERVAL			= 0x00403850,	/* R/W, sec,	"INTERNAL LINE INTERVAL"	*/	/* future */
...
#define	DCAM_IDPROP_CHANNEL_(ch,id)	((DCAMIDPROP)( ch * DCAM_IDPROP__CHANNEL + (long)id ))
...
#define	DCAM_IDPROP_VIEW_(view,id)	((DCAMIDPROP)( view * DCAM_IDPROP__VIEW + (long)id ))
