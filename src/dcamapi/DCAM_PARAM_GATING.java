...
public class DCAM_PARAM_GATING extends StructObject {
	 ...
	 */
	@Field(0) 
	public DCAM_PARAM_GATING hdr(DCAM_HDR_PARAM hdr) {
	...
	/// [in/out] gating control
	@Field(1) 
	public DCAM_PARAM_GATING flags(int flags) {
	...
	/// [in/out] interval time by second
	@Field(2) 
	public DCAM_PARAM_GATING interval(double interval) {
	...
	/// [in/out] delay time by second
	@Field(3) 
	public DCAM_PARAM_GATING delay(double delay) {
	...
	/// [in/out] gating period by second.
	@Field(4) 
	public DCAM_PARAM_GATING width(double width) {
		this.io.setDoubleField(this, 4, width);
		return this;
	}
	public DCAM_PARAM_GATING(Pointer pointer) {
		super(pointer);
	}
}
