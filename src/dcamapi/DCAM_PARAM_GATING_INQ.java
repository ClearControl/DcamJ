...
public class DCAM_PARAM_GATING_INQ extends StructObject {
	 ...
	 */
	@Field(0) 
	public DCAM_PARAM_GATING_INQ hdr(DCAM_HDR_PARAM hdr) {
	...
	@CLong 
	@Field(1) 
	public DCAM_PARAM_GATING_INQ trigmode(long trigmode) {
	...
	/// [out] gating capability
	@Field(2) 
	public DCAM_PARAM_GATING_INQ capflags(int capflags) {
	...
	/// [out] minimum time of interval by second.
	@Field(3) 
	public DCAM_PARAM_GATING_INQ intervalmin(double intervalmin) {
	...
	/// [out] maximum time of interval by second.
	@Field(4) 
	public DCAM_PARAM_GATING_INQ intervalmax(double intervalmax) {
	...
	/// [out] step time of interval by second. This was intervalystep
	@Field(5) 
	public DCAM_PARAM_GATING_INQ intervalstep(double intervalstep) {
	...
	/// [out] minimum time of delay by second.
	@Field(6) 
	public DCAM_PARAM_GATING_INQ delaymin(double delaymin) {
	...
	/// [out] maximum time of delay by second.
	@Field(7) 
	public DCAM_PARAM_GATING_INQ delaymax(double delaymax) {
	...
	/// [out] step time of delay by second.
	@Field(8) 
	public DCAM_PARAM_GATING_INQ delaystep(double delaystep) {
	...
	/// [out] minimum time of width by second.
	@Field(9) 
	public DCAM_PARAM_GATING_INQ widthmin(double widthmin) {
	...
	/// [out] maximum time of width by second.
	@Field(10) 
	public DCAM_PARAM_GATING_INQ widthmax(double widthmax) {
	...
	/// [out] step time of width by second.
	@Field(11) 
	public DCAM_PARAM_GATING_INQ widthstep(double widthstep) {
		this.io.setDoubleField(this, 11, widthstep);
		return this;
	}
	public DCAM_PARAM_GATING_INQ(Pointer pointer) {
		super(pointer);
	}
}
