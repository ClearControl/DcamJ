...
public class DCAM_PARAM_RGBRATIO extends StructObject {
	 ...
	 */
	@Field(0) 
	public DCAM_PARAM_RGBRATIO hdr(DCAM_HDR_PARAM hdr) {
	...
	/// C type : dcam_rgbratio
	@Field(1) 
	public DCAM_PARAM_RGBRATIO exposure(dcam_rgbratio exposure) {
	...
	/// C type : dcam_rgbratio
	@Field(2) 
	public DCAM_PARAM_RGBRATIO gain(dcam_rgbratio gain) {
		this.io.setNativeObjectField(this, 2, gain);
		return this;
	}
	public DCAM_PARAM_RGBRATIO(Pointer pointer) {
		super(pointer);
	}
}
