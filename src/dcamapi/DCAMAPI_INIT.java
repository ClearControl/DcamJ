...
public class DCAMAPI_INIT extends StructObject {
	...
	@CLong 
	@Field(0) 
	public DCAMAPI_INIT size(long size) {
	...
	@CLong 
	@Field(1) 
	public DCAMAPI_INIT iDeviceCount(long iDeviceCount) {
	...
	@CLong 
	@Field(2) 
	public DCAMAPI_INIT apiver(long apiver) {
	...
	@CLong 
	@Field(3) 
	public DCAMAPI_INIT reserved(long reserved) {
	 ...
	 */
	@Field(4) 
	public DCAMAPI_INIT initoption(Pointer<CLong > initoption) {
	 ...
	 */
	@Field(5) 
	public DCAMAPI_INIT guid(Pointer<DCAM_GUID > guid) {
		this.io.setPointerField(this, 5, guid);
		return this;
	}
	public DCAMAPI_INIT(Pointer pointer) {
		super(pointer);
	}
}
