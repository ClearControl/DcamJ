...
// defined( MAC_OS_X_VERSION_ACTUAL )									// [[ reserved ]]
#if ! defined( TARGET_CARBON ) && ! defined( MAC_OS_X_VERSION_10_0 )	// [[ future ]]
#error Carbon.H or Cocoa.H is necessary for MacOSX platform				// [[ future ]]
#endif																	// [[ future ]]
...
#ifndef DCAM_TARGETOS_IS_WIN32
typedef unsigned char		BYTE;
#endif

/* define for Linux */													/*[[ future ]]*/
																		/*[[ future ]]*/
#ifdef DCAM_TARGETOS_IS_LINUX											/*[[ future ]]*/
																		/*[[ future ]]*/
typedef uint32_t			BOOL;										/*[[ future ]]*/
																		/*[[ future ]]*/
#endif																	/*[[ future ]]*/
...
DCAM_DECLARE_BEGIN( enum, DCAM_DATATYPE )
{
	...
	DCAM_DATATYPE_UINT12		=	0x00000004,	/* bit 2 */	 /*[[ internal ]]*/
	DCAM_DATATYPE_UINT32		=	0x00000008,	/* bit 3 */
	DCAM_DATATYPE_UINT8_EVEN	=	0x00002000,	/* bit 12 */ /*[[ internal ]]*/
	DCAM_DATATYPE_UINT8_ODD		=	0x00004000,	/* bit 13 */ /*[[ internal ]]*/
	...
	DCAM_DATATYPE_UINT16_EVEN	=	0x10000000,	/* bit 28 */ /*[[ internal ]]*/
	DCAM_DATATYPE_UINT16_ODD	=	0x20000000,	/* bit 29 */ /*[[ internal ]]*/
	DCAM_DATATYPE_UINT12_EVEN	=	0x40000000,	/* bit 30 */ /*[[ internal ]]*/
	DCAM_DATATYPE_UINT12_ODD	=	0x80000000,	/* bit 31 */ /*[[ internal ]]*/
...
enum {
	...
	, _DCAM_QUERYCAPABILITY_FGTRIGGERS		= 5		/*[[ internal ]]*/
	, _DCAM_QUERYCAPABILITY_TRIGGERSOURCES	= 6		/*[[ internal ]]*/
};
...
enum {
	...
	/*** --- from 3.20 --- ***/									/*[[ ver:3200- ]]*/
	DCAM_CAPABILITY_LOCK_USERMEMORY				= 0x04000000,	/*[[ ver:3200- ]]*/
...
#if DCAMAPI_VER >= 3500																	/*[[ ver:3500- ]]*/

BOOL DCAMAPI dcam_lockusermemory		( HDCAM h, void* buftop, void* buflast );		/*[[ ver:3500- ]]*/
BOOL DCAMAPI dcam_unlockusermemory		( HDCAM h, void* buftop, void* buflast );		/*[[ ver:3500- ]]*/
...
BOOL DCAMAPI dcam_captureex				( HDCAM h, int32 iFrame );	/*[[ future ]]*/
...
BOOL DCAMAPI dcam_resettrigger			( HDCAM h );		/*[[ future ]]*/

/*** --- HDCAMWAITABORT --- ***/		/*[[ future ]]*/
// DCAMERR DCAMAPI dcamwaitabort_create	( HDCAMWAITABORT* phAbort );					/*[[ future ]]*/
// DCAMERR DCAMAPI dcamwaitabort_destroy( HDCAMWAITABORT hAbort );						/*[[ future ]]*/
// DCAMERR DCAMAPI dcamwaitabort_signal	( HDCAMWAITABORT hAbort );						/*[[ future ]]*/
// BOOL DCAMAPI dcam_waitex				( HDCAM h, DCAM_WAITEX* param, _DWORD size );	/*[[ future ]]*/
...
//	ARPAPI_IDFEATURE_DELAYREADOUT	= 0x00000018,		/*[[ internal ]]*/
//	ARPAPI_IDFEATURE_BITSPERCHANNEL	= 0x0000001a,		/*[[ internal ]]*/
//	ARPAPI_IDFEATURE_TEMPERATURE2	= 0x0000001b,		/*[[ internal ]]*/
};
