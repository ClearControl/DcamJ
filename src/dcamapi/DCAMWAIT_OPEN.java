...
public class DCAMWAIT_OPEN extends StructObject {
	...
	@CLong 
	@Field(0) 
	public DCAMWAIT_OPEN size(long size) {
	...
	@CLong 
	@Field(1) 
	public DCAMWAIT_OPEN supportevent(long supportevent) {
	 ...
	 */
	@Field(2) 
	public DCAMWAIT_OPEN hwait(Pointer<HDCAMWAIT_struct > hwait) {
	 ...
	 */
	@Field(3) 
	public DCAMWAIT_OPEN hdcam(Pointer<HDCAM_struct > hdcam) {
		this.io.setPointerField(this, 3, hdcam);
		return this;
	}
	public DCAMWAIT_OPEN(Pointer pointer) {
		super(pointer);
	}
}
