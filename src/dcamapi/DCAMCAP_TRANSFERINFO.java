...
public class DCAMCAP_TRANSFERINFO extends StructObject {
	...
	@CLong 
	@Field(0) 
	public DCAMCAP_TRANSFERINFO size(long size) {
	...
	@CLong 
	@Field(1) 
	public DCAMCAP_TRANSFERINFO reserved(long reserved) {
	...
	@CLong 
	@Field(2) 
	public DCAMCAP_TRANSFERINFO nNewestFrameIndex(long nNewestFrameIndex) {
	...
	@CLong 
	@Field(3) 
	public DCAMCAP_TRANSFERINFO nFrameCount(long nFrameCount) {
		this.io.setCLongField(this, 3, nFrameCount);
		return this;
	}
	public DCAMCAP_TRANSFERINFO(Pointer pointer) {
		super(pointer);
	}
}
