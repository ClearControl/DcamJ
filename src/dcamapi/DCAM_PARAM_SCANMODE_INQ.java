...
public class DCAM_PARAM_SCANMODE_INQ extends StructObject {
	 ...
	 */
	@Field(0) 
	public DCAM_PARAM_SCANMODE_INQ hdr(DCAM_HDR_PARAM hdr) {
	...
	/// [out]
	@Field(1) 
	public DCAM_PARAM_SCANMODE_INQ speedmax(int speedmax) {
	...
	/// [in/out]
	@Field(2) 
	public DCAM_PARAM_SCANMODE_INQ special(int special) {
		this.io.setIntField(this, 2, special);
		return this;
	}
	public DCAM_PARAM_SCANMODE_INQ(Pointer pointer) {
		super(pointer);
	}
}
