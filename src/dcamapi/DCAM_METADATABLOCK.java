...
public class DCAM_METADATABLOCK extends StructObject {
	...
	/// C type : DCAM_METADATABLOCKHDR
	@Field(0) 
	public DCAM_METADATABLOCK hdr(DCAM_METADATABLOCKHDR hdr) {
	 ...
	 */
	@Field(1) 
	public DCAM_METADATABLOCK buf(Pointer<? > buf) {
	 ...
	 */
	@Field(2) 
	public DCAM_METADATABLOCK unitsizes(Pointer<CLong > unitsizes) {
	...
	@CLong 
	@Field(3) 
	public DCAM_METADATABLOCK bytesperunit(long bytesperunit) {
	...
	@CLong 
	@Field(4) 
	public DCAM_METADATABLOCK userdataKind(long userdataKind) {
		this.io.setCLongField(this, 4, userdataKind);
		return this;
	}
	public DCAM_METADATABLOCK(Pointer pointer) {
		super(pointer);
	}
}
