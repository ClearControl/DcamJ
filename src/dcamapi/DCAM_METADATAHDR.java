...
public class DCAM_METADATAHDR extends StructObject {
	...
	@CLong 
	@Field(0) 
	public DCAM_METADATAHDR size(long size) {
	...
	@CLong 
	@Field(1) 
	public DCAM_METADATAHDR iKind(long iKind) {
	...
	@CLong 
	@Field(2) 
	public DCAM_METADATAHDR option(long option) {
	...
	@CLong 
	@Field(3) 
	public DCAM_METADATAHDR iFrame(long iFrame) {
		this.io.setCLongField(this, 3, iFrame);
		return this;
	}
	public DCAM_METADATAHDR(Pointer pointer) {
		super(pointer);
	}
}
