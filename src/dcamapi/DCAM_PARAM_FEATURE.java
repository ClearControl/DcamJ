...
public class DCAM_PARAM_FEATURE extends StructObject {
	 ...
	 */
	@Field(0) 
	public DCAM_PARAM_FEATURE hdr(DCAM_HDR_PARAM hdr) {
	...
	@CLong 
	@Field(1) 
	public DCAM_PARAM_FEATURE featureid(long featureid) {
	...
	@CLong 
	@Field(2) 
	public DCAM_PARAM_FEATURE flags(long flags) {
	...
	/// [in/out]
	@Field(3) 
	public DCAM_PARAM_FEATURE featurevalue(float featurevalue) {
		this.io.setFloatField(this, 3, featurevalue);
		return this;
	}
	public DCAM_PARAM_FEATURE(Pointer pointer) {
		super(pointer);
	}
}
