...
public class DCAM_USERDATABIN extends StructObject {
	...
	/// C type : DCAM_METADATAHDR
	@Field(0) 
	public DCAM_USERDATABIN hdr(DCAM_METADATAHDR hdr) {
	...
	/// C type : void*
	@Field(1) 
	public DCAM_USERDATABIN bin(Pointer<? > bin) {
	...
	@CLong 
	@Field(2) 
	public DCAM_USERDATABIN binLen(long binLen) {
	...
	@CLong 
	@Field(3) 
	public DCAM_USERDATABIN reserved(long reserved) {
		this.io.setCLongField(this, 3, reserved);
		return this;
	}
	public DCAM_USERDATABIN(Pointer pointer) {
		super(pointer);
	}
}
