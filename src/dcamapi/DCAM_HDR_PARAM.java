...
public class DCAM_HDR_PARAM extends StructObject {
	...
	@CLong 
	@Field(0) 
	public DCAM_HDR_PARAM cbSize(long cbSize) {
	...
	@CLong 
	@Field(1) 
	public DCAM_HDR_PARAM id(long id) {
	...
	@CLong 
	@Field(2) 
	public DCAM_HDR_PARAM iFlag(long iFlag) {
	...
	@CLong 
	@Field(3) 
	public DCAM_HDR_PARAM oFlag(long oFlag) {
		this.io.setCLongField(this, 3, oFlag);
		return this;
	}
	public DCAM_HDR_PARAM(Pointer pointer) {
		super(pointer);
	}
}
