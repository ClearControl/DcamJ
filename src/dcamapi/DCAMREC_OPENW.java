...
public class DCAMREC_OPENW extends StructObject {
	...
	@CLong 
	@Field(0) 
	public DCAMREC_OPENW size(long size) {
	...
	@CLong 
	@Field(1) 
	public DCAMREC_OPENW reserved(long reserved) {
	 ...
	 */
	@Field(2) 
	public DCAMREC_OPENW hrec(Pointer<HDCAMREC_struct > hrec) {
	 ...
	 */
	@Field(3) 
	public DCAMREC_OPENW path(Pointer<Character > path) {
	 ...
	 */
	@Field(4) 
	public DCAMREC_OPENW ext(Pointer<Character > ext) {
	...
	@CLong 
	@Field(5) 
	public DCAMREC_OPENW maxframepersession(long maxframepersession) {
	...
	@CLong 
	@Field(6) 
	public DCAMREC_OPENW userdatasize(long userdatasize) {
	...
	@CLong 
	@Field(7) 
	public DCAMREC_OPENW userdatasizeSession(long userdatasizeSession) {
	...
	@CLong 
	@Field(8) 
	public DCAMREC_OPENW userdatasizeFile(long userdatasizeFile) {
	...
	@CLong 
	@Field(9) 
	public DCAMREC_OPENW usertextsize(long usertextsize) {
	...
	@CLong 
	@Field(10) 
	public DCAMREC_OPENW usertextsizeSession(long usertextsizeSession) {
	...
	@CLong 
	@Field(11) 
	public DCAMREC_OPENW usertextsizeFile(long usertextsizeFile) {
		this.io.setCLongField(this, 11, usertextsizeFile);
		return this;
	}
	public DCAMREC_OPENW(Pointer pointer) {
		super(pointer);
	}
}
