 ...
 */
@Library("dcamapi")
public class HDCAM_struct extends StructObject
{
	public HDCAM_struct()
	{
		super();
	...
	@CLong
	@Field(0)
	public HDCAM_struct data1(final long data1)
	{
	...
	@CLong
	@Field(1)
	public HDCAM_struct data2(final long data2)
	{
		this.io.setCLongField(this, 1, data2);
		return this;
	}

	public HDCAM_struct(final Pointer pointer)
	{
		super(pointer);
	}
}
